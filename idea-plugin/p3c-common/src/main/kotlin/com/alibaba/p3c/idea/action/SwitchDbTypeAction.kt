 ...
 * @date 2017/06/20
 */
class SwitchDbTypeAction : AnAction(), DumbAware {
    private val p3cConfig = P3cConfig::class.java.getService()

    private val textKey = "com.alibaba.p3c.action.switch_dbType.text"

    override fun actionPerformed(e: AnActionEvent) {
        p3cConfig.toggleDbType()
    ...
    override fun update(e: AnActionEvent) {
        e.presentation.text = P3cBundle.getMessage("$textKey.cur_${p3cConfig.dbType}")
    }
}
