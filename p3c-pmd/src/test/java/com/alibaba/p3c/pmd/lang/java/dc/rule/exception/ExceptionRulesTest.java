...
public class ExceptionRulesTest extends SimpleAggregatorTst {
    ...
    public static final String RULESET = "java-dc-exception";

    @Override
    public void setUp() {
        addRule(RULESET, "AvoidCreateBusiExceptionUsingNonErrorCode");
        addRule(RULESET, "CatchStatmentShouldHaveLogError");
